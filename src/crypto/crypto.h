 ...
 * to implement this.
 */
void crypto_hash_update(struct crypto_hash *ctx, const uint8_t *data,
                        size_t len);
 ...
 * to implement this.
 */
struct crypto_public_key *crypto_public_key_import(const uint8_t *key,
                                                   size_t len);
 ...
 */
struct crypto_private_key *
crypto_private_key_import(const uint8_t *key, size_t len, const char *passwd);
