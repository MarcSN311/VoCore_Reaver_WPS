 ...
 */
static const uint8_t dh_group1_generator[1] = {0x02};
static const uint8_t dh_group1_prime[96] = {
 ...
 */
static const uint8_t dh_group2_generator[1] = {0x02};
static const uint8_t dh_group2_prime[128] = {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,
    0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,
    0x3B, 0x13, 0x9B, 0x22, 0x51, 0x4A, 0x08, 0x79, 0x8E, 0x34, 0x04, 0xDD,
 ...
 */
static const uint8_t dh_group14_generator[1] = {0x02};
 ...
 */
static const uint8_t dh_group15_generator[1] = {0x02};
 ...
 */
static const uint8_t dh_group16_generator[1] = {0x02};
static const uint8_t dh_group16_prime[512] = {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,
    0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,
    0x3B, 0x13, 0x9B, 0x22, 0x51, 0x4A, 0x08, 0x79, 0x8E, 0x34, 0x04, 0xDD,
 ...
 */
static const uint8_t dh_group17_generator[1] = {0x02};
static const uint8_t dh_group17_prime[768] = {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,
    0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,
    0x3B, 0x13, 0x9B, 0x22, 0x51, 0x4A, 0x08, 0x79, 0x8E, 0x34, 0x04, 0xDD,
 ...
 */
static const uint8_t dh_group18_generator[1] = {0x02};
static const uint8_t dh_group18_prime[1024] = {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,
    0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,
    0x3B, 0x13, 0x9B, 0x22, 0x51, 0x4A, 0x08, 0x79, 0x8E, 0x34, 0x04, 0xDD,
...
static struct dh_group dh_groups[] = {DH_GROUP(5),
#ifdef ALL_DH_GROUPS
                                      DH_GROUP(1),  DH_GROUP(2),  DH_GROUP(14),
                                      DH_GROUP(15), DH_GROUP(16), DH_GROUP(17),
                                      DH_GROUP(18)
#endif /* ALL_DH_GROUPS */
};
...
struct wpabuf *dh_init(const struct dh_group *dh, struct wpabuf **priv) {
  ...
  *priv = wpabuf_alloc(dh->prime_len);
  ...
  if (0) // get_dh_small())
  {
    ...
    if (get_random(wpabuf_put(*priv, dh->prime_len), dh->prime_len))
      retval = 0;
  }
